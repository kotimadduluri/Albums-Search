...
class SearchRepository @Inject constructor(private val searchApi: SearchApi, private val dataCache: DataCache) {

    private val networkResponse= MutableLiveData<NetworkResponse<String>>()
    fun getNetworkObserver()=networkResponse
    fun getDataCache()=dataCache

    //to search given query
    suspend fun search(query:String,page:Int,pageSize:Int=PAGE_DEFULT_SIZE)=searchApi.search(query,page = page,perPage = pageSize)
